...
if("TRUE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /home/tju/test2/src/map_server)
  set(map_server_DEVEL_PREFIX /home/tju/test2/devel)
  ...
  set(map_server_INSTALL_PREFIX /home/tju/test2/install)
...
if(NOT "/home/tju/test2/src/map_server/include " STREQUAL " ")
  set(map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/tju/test2/src/map_server/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tju/test2/src/map_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tju/test2/devel/lib;/home/tju/racecar/devel/lib;/opt/ros/kinetic/lib)
